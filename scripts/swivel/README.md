...
This is a slightly modified version of Swivel, it has been derived from the official [Swivel implementation included as part of the TensorFlow models](https://github.com/tensorflow/models/tree/master/research/swivel). Changes have been made to make the code compatible with python3 and to (mostly) work on windows platforms (where 'utf-8' encoding is not always the default).
